...
export const imgData = {
  ...
  Deck: {
    DeckBeachdune: DeckBeachdune,
    DeckClamshell: DeckClamshell,
    DeckCoastalbluff: DeckCoastalbluff,
    DeckFirepit: DeckFirepit,
    DeckFoggywharf: DeckFoggywharf,
    DeckGravelpath: DeckGravelpath,
    DeckHavanagold: DeckHavanagold,
    DeckLavarock: DeckLavarock,
    DeckPebblegray: DeckPebblegray,
    DeckRockyharbor: DeckRockyharbor,
    DeckRopeswing: DeckRopeswing,
    DeckSaddle: DeckSaddle,
    DeckSpicedrum: DeckSpicedrum,
    DeckSunsetcove: DeckSunsetcove,
    DeckTikitorch: DeckTikitorch,
    DeckToastedsand: DeckToastedsand,
    DeckTreehouse: DeckTreehouse,
    DeckVintagelantern: DeckVintagelantern,
    DeckWinchestergray: DeckWinchestergray,
    DeckWoodlandbrown: DeckWoodlandbrown,
  ...
  "Cap Rail": {
    CrownFirepit: CrownFirepit,
    CrownGravelpath: CrownGravelpath,
    CrownHavanagold: CrownHavanagold,
    CrownIslandmist: CrownIslandmist,
    CrownLavarock: CrownLavarock,
    CrownRopeswing: CrownRopeswing,
    CrownSpicedrum: CrownSpicedrum,
    CrownTikitorch: CrownTikitorch,
    CrownTreehouse: CrownTreehouse,
    CrownVintagelantern: CrownVintagelantern,
