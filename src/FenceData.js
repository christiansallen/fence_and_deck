...
export const imgData = {
  "Post Sleeve": {
    White: SpostWhite,
    Charcoal: SpostCharcoal,
    FirePit: SpostFirepit,
    Gravelpath: SpostGravelpath,
    Havanagold: SpostHavanagold,
    Ropeswing: SpostRopeswing,
    Vintagelantern: SpostVintagelantern
  },
  Deck: {
    Beachdune: DeckBeachdune,
    Clamshell: DeckClamshell,
    Coastalbluff: DeckCoastalbluff,
    Firepit: DeckFirepit,
    Foggywharf: DeckFoggywharf,
    Gravelpath: DeckGravelpath,
    Havanagold: DeckHavanagold,
    Lavarock: DeckLavarock,
    Pebblegray: DeckPebblegray,
    Rockyharbor: DeckRockyharbor,
    Ropeswing: DeckRopeswing,
    Saddle: DeckSaddle,
    Spicedrum: DeckSpicedrum,
    Sunsetcove: DeckSunsetcove,
    Tikitorch: DeckTikitorch,
    Toastedsand: DeckToastedsand,
    Treehouse: DeckTreehouse,
    Vintagelantern: DeckVintagelantern,
    Winchestergray: DeckWinchestergray,
    Woodlandbrown: DeckWoodlandbrown,
    Islandmist: DeckIslandmist,
    Maderia: DeckMaderia
  },
  "Post Cap": {
    Charcoal: FlatCharcoal,
    Firepit: FlatFirepit,
    Gravelpath: FlatGravelpath,
    Havanagold: FlatHavanagold,
    White: FlatWhite,
    Ropeswing: FlatRopeswing,
    Vintagelantern: FlatVintagelantern,
  ...
  "Post Skirt": {
    Charcoal: SkirtCharcoal,
    Firepit: SkirtFirepit,
    Gravelpath: SkirtGravelpath,
    Havanagold: SkirtHavanagold,
    White: SkirtWhite,
    Ropeswing: SkirtRopeswing,
    Vintagelantern: SkirtVintagelantern
  },
  "Cap Rail": {
    Firepit: CrownFirepit,
    Gravelpath: CrownGravelpath,
    Havanagold: CrownHavanagold,
    Islandmist: CrownIslandmist,
    Lavarock: CrownLavarock,
    Ropeswing: CrownRopeswing,
  ...
  Border: {
    ...
    BorderClamshell: BorderClamshell,
    BorderCoastalbluff: BorderCoastalbluff,
    BorderFirepit: BorderFirepit,
    BorderFoggywharf: BorderFoggywharf,
    ...
    BorderRopeswing: BorderRopeswing,
    BorderSaddle: BorderSaddle,
    BorderSpicedrum: BorderSpicedrum,
    BorderSunsetcove: BorderSunsetcove,
    BorderTikitorch: BorderTikitorch,
    BorderToastedsand: BorderToastedsand,
    BorderTreehouse: BorderTreehouse,
    BorderVintagelantern: BorderVintagelantern,
    BorderWinchestergray: BorderWinchestergray,
    BorderWoodlandbrown: BorderWoodlandbrown
  },
  Fascia: {
    FasciaBeachdune: FasciaBeachdune,
    FasciaClamshell: FasciaClamshell,
    FasciaCoastalbluff: FasciaCoastalbluff,
    FasciaFirepit: FasciaFirepit,
    FasciaFoggywharf: FasciaFoggywharf,
    FasciaGravelpath: FasciaGravelpath,
    FasciaHavanagold: FasciaHavanagold,
    FasciaLavarock: FasciaLavarock,
    FasciaPebblegray: FasciaPebblegray,
    FasciaRockyharbor: FasciaRockyharbor,
    FasciaRopeswing: FasciaRopeswing,
    FasciaSaddle: FasciaSaddle,
    FasciaSpicedrum: FasciaSpicedrum,
    FasciaSunsetcove: FasciaSunsetcove,
    FasciaTikitorch: FasciaTikitorch,
    FasciaToastedsand: FasciaToastedsand,
    FasciaTreehouse: FasciaTreehouse,
    FasciaVintagelantern: FasciaVintagelantern,
